...
public class PdfGenerator {
    ...
    public interface Build {
        ...
        Build setFolderPath(String folderName);
    ...
    public static class Builder implements Build, FileNameStep, PageSizeStep
        ...
        private void openGeneratedPDF() {
            try {
                ...
                if (file.exists()) {
                    ...
                    postFailure("PDF file is not existing in storage. Your Generated path is " + folderName);
                }
        ...
        private void print() {
            ...
            try {
                if (context != null) {
                    ...
                    targetPdf = folderName+"/" + fileName + ".pdf";
        ...
        @Override
        public Build setFolderPath(String folderName) {
